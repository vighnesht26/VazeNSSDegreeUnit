...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2026 at 06:35 PM
...
INSERT INTO `attendance` (`event_id`, `attendance_no`, `reporting_mark`, `end_mark`, `isabsent`, `hrs_alloted`, `student_id`, `marked_by`, `Status`) VALUES
(5, 1, NULL, NULL, 'yes', 0.0, 28, NULL, NULL),
(5, 2, NULL, NULL, 'yes', 0.0, 29, NULL, NULL);
...
INSERT INTO `event` (`event_id`, `name`, `date`, `time`, `venue`, `organised_by`, `collaboration`, `event_type`, `approx_hrs`, `max_participation`, `status`, `reporting_time`, `reporting_venue`, `description`, `alloted_hrs`, `created_at`, `updated_at`, `created_by_admin`, `created_by_leader`) VALUES
(2, 'Tree Plantation', '2026-08-12', '07:30:00', 'college', 'clg', 'no', 'ABP-1', 2.0, 2, 'Scheduled', '07:00:00', 'unit', 'ewrwefdawrefwaef', 0.0, '2026-07-23 15:32:01', '2026-08-09 21:39:37', 2, NULL),
(3, 'Independance Day', '2026-08-15', '08:00:00', 'college', 'NSS Degree Unit', 'NONE', 'CL', 2.0, 40, 'Scheduled', '07:30:00', 'college foyer', '', 0.0, '2026-07-30 20:01:21', '2026-08-09 20:10:49', 2, NULL),
(5, 'Cleanliness Drive', '2026-08-10', '08:00:00', 'college', 'NSS Degree Unit', 'NONE', 'ABP-1', 2.0, 40, 'Scheduled', '07:30:00', 'college foyer', '', 0.0, '2026-08-01 19:12:16', '2026-08-09 20:45:38', 2, NULL),
(6, 'Republic day ', '2027-01-26', '08:00:00', 'College', 'College', 'None', 'CL', 2.0, 20, 'Scheduled', '07:30:00', 'College foyer', '', 0.0, '2026-08-07 15:55:56', '2026-08-07 15:55:56', 2, NULL),
(7, 'Cleanliness drive', '2026-08-20', '08:30:00', 'Gravyard Road', 'NSS Degree Unit', 'NA', 'ABP-1', 2.0, 40, 'Tentative', '08:00:00', 'NSS Degree Unit', 'The 🔰 NSS Degree Unit🔰 of The KET\'s V. G. Vaze College is organizing a 🧹 Cleanliness Drive to promote cleanliness, hygiene, and environmental responsibility among students and the college community.\r\n\r\nThe drive aims to encourage NSS volunteers to actively contribute towards maintaining a clean, healthy, and sustainable campus while spreading awareness about the importance of cleanliness and responsible waste management. 🌱♻️', 0.0, '2026-08-09 19:41:56', '2026-08-09 20:11:00', 2, NULL);
...
(29, 'Dhananjay1236', 'Dhananjay', 'Prakash', 'Pramila', 'Shelar', 'Dhanajay26@gmail.com', 'Male', '7896541236', 'A+', 'GENERAL', '2006-09-26', 'Volunteer', '$2y$10$Dr0xHAJcweADqb0aKgsXo.LTlJ8OTHMxuHTJoWgAL7ic9bzJhmSlq', NULL, '2026-08-10 19:31:57', '2026-08-10 19:31:57', NULL);
