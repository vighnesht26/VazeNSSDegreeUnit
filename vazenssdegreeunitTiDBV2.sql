-- TiDB Compatible Clean SQL Dump
...
CREATE TABLE `admin` (
  ...
  KEY `clg_id` (`clg_id`),
  KEY `email` (`email`),
  CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`clg_id`) REFERENCES `college` (`clg_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_ibfk_1` FOREIGN KEY (`approved_by`) REFERENCES `student` (`std_id`) ON DELETE SET NULL,
  CONSTRAINT `student_ibfk_2` FOREIGN KEY (`assigned_by`) REFERENCES `admin` (`admin_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `academic_details` (
  ...
  CONSTRAINT `academic_details_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`std_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `event` (
  ...
  KEY `created_by_leader` (`created_by_leader`),
  CONSTRAINT `event_ibfk_1` FOREIGN KEY (`created_by_admin`) REFERENCES `admin` (`admin_id`) ON DELETE SET NULL,
  CONSTRAINT `event_ibfk_2` FOREIGN KEY (`created_by_leader`) REFERENCES `student` (`std_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'Cleanliness Drive', '2026-08-10', '08:00:00', 'college', 'NSS Degree Unit', 'NONE', 'ABP-1', 2.5, 40, 'Active', '07:30:00', 'college foyer', '', 'Pending', 'Pending', 'Pending', 0.0, '2026-08-01 19:12:16', '2026-08-09 20:45:38', 2, NULL),
...
CREATE TABLE `attendance` (
  ...
  PRIMARY KEY (`event_id`,`attendance_no`),
  KEY `student_id` (`student_id`),
  KEY `marked_by_leader` (`marked_by_leader`),
  KEY `marked_by_admin` (`marked_by_admin`),
  CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE,
  CONSTRAINT `attendance_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student` (`std_id`) ON DELETE CASCADE,
  CONSTRAINT `attendance_ibfk_3` FOREIGN KEY (`marked_by_leader`) REFERENCES `student` (`std_id`) ON DELETE SET NULL,
  CONSTRAINT `attendance_ibfk_4` FOREIGN KEY (`marked_by_admin`) REFERENCES `admin` (`admin_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 1, '2026-08-13 18:53:19', 'no', 28, 29, NULL),
(5, 2, '2026-09-03 17:39:32', 'no', 29, 29, NULL),
...
CREATE TABLE `faq` (
  ...
  PRIMARY KEY (`f_id`),
  KEY `ans_by` (`ans_by`),
  CONSTRAINT `faq_ibfk_1` FOREIGN KEY (`ans_by`) REFERENCES `student` (`std_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `feedback` (
  ...
  `question` text NOT NULL,
  `q_type` enum('rating','textarea','text') NOT NULL DEFAULT 'text',
  `event_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`q_id`),
  KEY `event_id` (`event_id`),
  CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `feedback` (`q_id`, `question`, `q_type`, `event_id`) VALUES
(1, 'Rate the experience of event', 'rating', 3),
(2, 'How was the event', 'text', 3);
...
CREATE TABLE `report` (
  ...
  KEY `for_event` (`for_event`),
  CONSTRAINT `report_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `student` (`std_id`) ON DELETE SET NULL,
  CONSTRAINT `report_ibfk_2` FOREIGN KEY (`for_event`) REFERENCES `event` (`event_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `response` (
  ...
  KEY `q_id` (`q_id`),
  KEY `ans_by` (`ans_by`),
  CONSTRAINT `response_ibfk_1` FOREIGN KEY (`q_id`) REFERENCES `feedback` (`q_id`) ON DELETE CASCADE,
  CONSTRAINT `response_ibfk_2` FOREIGN KEY (`ans_by`) REFERENCES `student` (`std_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
